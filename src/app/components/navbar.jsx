  ...
  return (
    <>
      <nav className="sticky top-0 z-40 w-full bg-[#0a0a0a]/90 backdrop-blur-md border-b border-white/10">
        ...
        <div className="px-4 md:px-8 py-2.5 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="md:hidden p-2 hover:bg-white/10 rounded-xl transition-colors duration-150"
            >
        ...
        {/* Mobile drawer */}
        {drawerOpen && (
          <div className="md:hidden border-t border-white/10 px-4 py-4 flex flex-col gap-3 bg-[#0a0a0a]">
            {/* Mobile search */}
            <SearchBar onSearch={handleSearch} />
            ...
            <div className="flex flex-col gap-1 pt-1">
              {NAV_LINKS.map(({ label, href }) => (
                <a
                  ...
                  className="text-sm font-medium text-gray-300 hover:text-white hover:bg-white/10 px-4 py-2.5 rounded-xl transition-colors duration-150"
                >
                  {label}
                </a>
              ))}
